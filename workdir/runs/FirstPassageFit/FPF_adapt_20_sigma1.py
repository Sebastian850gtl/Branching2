...
sigmaf = lambda x : sigma # diffusion d'un cluster d'une seule particule egale a 0 pour une particule plus grande que 1 (pour que le cluster au centre soit immobile)
...
fun = lambda x : R**2* (-np.log(x) +1/2*np.log(2)-1/2)
