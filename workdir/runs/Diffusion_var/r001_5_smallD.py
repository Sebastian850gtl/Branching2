...
# Range of coefficient of diffusion

diffusion_coef_min, diffusion_coef_max = 0, 2
nb_diffusion_points = 8
diffusion_range = np.linspace(diffusion_coef_min,diffusion_coef_max,nb_diffusion_points)
...
if run:
    ...
    plt.scatter(diffusion_range,meanTs,label = '$\mathbb{E}[\hat{T}]$',color = 'blue')
    plt.legend()
    plt.ylabel("Time")
